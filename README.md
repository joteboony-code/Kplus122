...
เมื่อพบสลิป KPLUS ที่ถูกต้อง ระบบบันทึกผลผ่านและปิดรอบตรวจโดยไม่ส่งข้อความกลับ LINE ส่วนผลตรวจไม่ผ่านจะแจ้งเตือนตามปกติ
...
4. เมื่อผ่าน ระบบต้องเงียบและบันทึกผลตามปกติ
5. ส่งสลิป KPLUS ที่ยอดไม่ถูกต้อง ระบบต้องแจ้ง `ตรวจสอบไม่ผ่าน` พร้อมสาเหตุ

## การตอบล่าช้า

ระบบประมวลผลผ่าน Queue แล้วพยายามใช้ Reply token สำหรับผลตรวจไม่ผ่านก่อน เพื่อประหยัดโควตาข้อความ หาก Queue ล่าช้าจน Reply token ใช้ไม่ได้ ระบบจะบันทึก error ไว้ แต่จะไม่ Push ซ้ำโดยค่าเริ่มต้น
