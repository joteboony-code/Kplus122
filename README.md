...
เมื่อมีการส่งรูปแล้วรูปไม่เข้าเงื่อนไขตอบผลตรวจผ่าน/ไม่ผ่าน ระบบจะตอบ Flex `เปิด Stock` พร้อม Tid 8 ตัวล่าสุดของผู้ส่งเพียงครั้งเดียวต่อรอบด้วย Reply API หากไม่พบ Tid จะแสดง `Tid: ไม่ระบุ` ส่วนผลตรวจผ่าน/ไม่ผ่านและคำสั่ง `Check Service`/`Service ทั้งหมด` ไม่เพิ่ม Flex Stock แยก เพราะมี Quick Reply อยู่แล้ว
