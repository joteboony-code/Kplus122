...
Cloudflare Worker สำหรับรับรูปจาก LINE Messaging API และตรวจสลิปเป็นรอบต่อผู้ส่ง โดยหนึ่งรอบต้องพบสลิปคนละ 2 ใบภายใน 5 นาที:
...
ระบบประมวลผลทีละหนึ่งรูป ป้องกัน Webhook/รูปเดิมซ้ำ 7 วัน สะสมสถานะรอบแยกตามผู้ส่งและกลุ่มเป็นเวลา 5 นาที และหยุดตรวจรูปถัดไปของผู้ส่งเดิมในกลุ่มเดิม 60 วินาทีหลังพบครบสองใบ
