...
Cloudflare Worker สำหรับรับรูปจาก LINE Messaging API และตรวจใบรายการ KPLUS/K+ โดยยอมรับจำนวนเงินอย่างใดอย่างหนึ่งดังนี้:
...
ระบบประมวลผลทีละหนึ่งรูป ป้องกัน Webhook/รูปเดิมซ้ำ 7 วัน และหยุดตรวจรูปถัดไปของผู้ส่งเดิมในกลุ่มเดิม 60 วินาทีหลังพบรูปที่ผ่าน
