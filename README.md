...
เมื่อพบสลิป KPLUS ที่ถูกต้อง ระบบตอบผ่านครั้งเดียวต่อชุดรูปด้วยข้อความ `เจอสลิป ผ่าน Kplus ยอด ... สลิปถูกต้อง` และไม่รอสลิป KBank
...
ระบบประมวลผลทีละหนึ่งรูป ป้องกัน Webhook/รูปเดิมซ้ำ 7 วัน แยกสถานะตามรหัสชุดรูปของ LINE และหยุดตอบซ้ำในชุดรูปเดิม 1 ชั่วโมงหลังพบสลิป KPLUS ที่ถูกต้อง หาก LINE ไม่ส่งรหัสชุดรูป ระบบจะระงับคำตอบซ้ำ 60 วินาที
