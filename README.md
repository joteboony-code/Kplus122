...
เมื่อมีการส่งรูปแล้วรูปไม่เข้าเงื่อนไขตอบผลตรวจผ่าน/ไม่ผ่าน ระบบจะตอบ Flex `เปิด Stock` เพียงครั้งเดียวต่อรอบของผู้ส่งด้วย Reply API ส่วนผลตรวจผ่าน/ไม่ผ่านและคำสั่ง `Check Service`/`Service ทั้งหมด` ไม่เพิ่ม Flex Stock แยก เพราะมี Quick Reply อยู่แล้ว
