...
เมื่อมีการส่งรูป ระบบแนบ Flex `เปิด Stock` กับผลตรวจผ่าน/ไม่ผ่าน หรือส่ง Flex นี้เพียงอย่างเดียวเมื่อรูปไม่เข้าเงื่อนไขตอบผลตรวจ โดยส่งเพียงครั้งเดียวต่อรอบของผู้ส่งและใช้ Reply API เท่านั้น คำสั่ง `Check Service` และ `Service ทั้งหมด` ไม่เพิ่ม Flex Stock แยก เพราะมี Quick Reply อยู่แล้ว
